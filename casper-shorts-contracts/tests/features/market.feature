Feature: Casper Shorts MarketContract tests
    ...
    Scenario: Going short twice
        ...
        Then MarketContract has 99.5 WCSPR
    ...
    Scenario: Going short and withdrawing
        ...
        Then MarketContract has 49.5 WCSPR
